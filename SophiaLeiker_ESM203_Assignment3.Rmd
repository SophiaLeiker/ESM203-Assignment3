---
title: "ESM203 Assignment 3: Homework 3 Analysis"
...
ggplot(massbal) + 
  ...
  labs(title = "Linear Trend Between the Input and Output Terms for the years 2000 and 2050")
...
massbal$chnge_lm <- -0.2266*massbal$years + 446.6
```
...
ggplot(massbal) + 
  ...
  theme(legend.title = element_blank()) + 
  ggtitle("Projected Groundwater Storage Under Business as Usual with 90% CI")
